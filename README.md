...
```sh
pip install git+https://github.com/dcermak/py-gitea-opensuse-org.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/dcermak/py-gitea-opensuse-org.git`)
