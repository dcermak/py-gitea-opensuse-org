...
class NotificationApi:
    ...
    async def notify_get_list(self, all : Annotated[Optional[StrictBool], Field(description="If true, show notifications marked as read. Default value is false")] = None, status_types : Annotated[Optional[conlist(StrictStr)], Field(description="Show notifications with the provided status types. Options are: unread, read and/or pinned. Defaults to unread & pinned.")] = None, subject_type : Annotated[Optional[conlist(StrictStr)], Field(description="filter notifications by subject type")] = None, since : Annotated[Optional[datetime], Field(description="Only show notifications updated after the given time. This is a timestamp in RFC 3339 format")] = None, before : Annotated[Optional[datetime], Field(description="Only show notifications updated before the given time. This is a timestamp in RFC 3339 format")] = None, page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> List[NotificationThread]:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the notify_get_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.notify_get_list_with_http_info(all, status_types, subject_type, since, before, page, limit, **kwargs)  # noqa: E501

    @validate_arguments
    async def notify_get_list_with_http_info(self, all : Annotated[Optional[StrictBool], Field(description="If true, show notifications marked as read. Default value is false")] = None, status_types : Annotated[Optional[conlist(StrictStr)], Field(description="Show notifications with the provided status types. Options are: unread, read and/or pinned. Defaults to unread & pinned.")] = None, subject_type : Annotated[Optional[conlist(StrictStr)], Field(description="filter notifications by subject type")] = None, since : Annotated[Optional[datetime], Field(description="Only show notifications updated after the given time. This is a timestamp in RFC 3339 format")] = None, before : Annotated[Optional[datetime], Field(description="Only show notifications updated before the given time. This is a timestamp in RFC 3339 format")] = None, page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List users's notification threads  # noqa: E501
    ...
    async def notify_get_repo_list(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], all : Annotated[Optional[StrictBool], Field(description="If true, show notifications marked as read. Default value is false")] = None, status_types : Annotated[Optional[conlist(StrictStr)], Field(description="Show notifications with the provided status types. Options are: unread, read and/or pinned. Defaults to unread & pinned")] = None, subject_type : Annotated[Optional[conlist(StrictStr)], Field(description="filter notifications by subject type")] = None, since : Annotated[Optional[datetime], Field(description="Only show notifications updated after the given time. This is a timestamp in RFC 3339 format")] = None, before : Annotated[Optional[datetime], Field(description="Only show notifications updated before the given time. This is a timestamp in RFC 3339 format")] = None, page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> List[NotificationThread]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the notify_get_repo_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.notify_get_repo_list_with_http_info(owner, repo, all, status_types, subject_type, since, before, page, limit, **kwargs)  # noqa: E501

    @validate_arguments
    async def notify_get_repo_list_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], all : Annotated[Optional[StrictBool], Field(description="If true, show notifications marked as read. Default value is false")] = None, status_types : Annotated[Optional[conlist(StrictStr)], Field(description="Show notifications with the provided status types. Options are: unread, read and/or pinned. Defaults to unread & pinned")] = None, subject_type : Annotated[Optional[conlist(StrictStr)], Field(description="filter notifications by subject type")] = None, since : Annotated[Optional[datetime], Field(description="Only show notifications updated after the given time. This is a timestamp in RFC 3339 format")] = None, before : Annotated[Optional[datetime], Field(description="Only show notifications updated before the given time. This is a timestamp in RFC 3339 format")] = None, page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List users's notification threads on a specific repo  # noqa: E501
    ...
    async def notify_get_thread(self, id : Annotated[StrictStr, Field(..., description="id of notification thread")], **kwargs) -> NotificationThread:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the notify_get_thread_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.notify_get_thread_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    async def notify_get_thread_with_http_info(self, id : Annotated[StrictStr, Field(..., description="id of notification thread")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get notification thread by ID  # noqa: E501
    ...
    async def notify_new_available(self, **kwargs) -> NotificationCount:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the notify_new_available_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.notify_new_available_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    async def notify_new_available_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Check if unread notifications exist  # noqa: E501
    ...
    async def notify_read_list(self, last_read_at : Annotated[Optional[datetime], Field(description="Describes the last point that notifications were checked. Anything updated since this time will not be updated.")] = None, all : Annotated[Optional[StrictStr], Field(description="If true, mark all notifications on this repo. Default value is false")] = None, status_types : Annotated[Optional[conlist(StrictStr)], Field(description="Mark notifications with the provided status types. Options are: unread, read and/or pinned. Defaults to unread.")] = None, to_status : Annotated[Optional[StrictStr], Field(description="Status to mark notifications as, Defaults to read.")] = None, **kwargs) -> List[NotificationThread]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the notify_read_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.notify_read_list_with_http_info(last_read_at, all, status_types, to_status, **kwargs)  # noqa: E501

    @validate_arguments
    async def notify_read_list_with_http_info(self, last_read_at : Annotated[Optional[datetime], Field(description="Describes the last point that notifications were checked. Anything updated since this time will not be updated.")] = None, all : Annotated[Optional[StrictStr], Field(description="If true, mark all notifications on this repo. Default value is false")] = None, status_types : Annotated[Optional[conlist(StrictStr)], Field(description="Mark notifications with the provided status types. Options are: unread, read and/or pinned. Defaults to unread.")] = None, to_status : Annotated[Optional[StrictStr], Field(description="Status to mark notifications as, Defaults to read.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Mark notification threads as read, pinned or unread  # noqa: E501
    ...
    async def notify_read_repo_list(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], all : Annotated[Optional[StrictStr], Field(description="If true, mark all notifications on this repo. Default value is false")] = None, status_types : Annotated[Optional[conlist(StrictStr)], Field(description="Mark notifications with the provided status types. Options are: unread, read and/or pinned. Defaults to unread.")] = None, to_status : Annotated[Optional[StrictStr], Field(description="Status to mark notifications as. Defaults to read.")] = None, last_read_at : Annotated[Optional[datetime], Field(description="Describes the last point that notifications were checked. Anything updated since this time will not be updated.")] = None, **kwargs) -> List[NotificationThread]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the notify_read_repo_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.notify_read_repo_list_with_http_info(owner, repo, all, status_types, to_status, last_read_at, **kwargs)  # noqa: E501

    @validate_arguments
    async def notify_read_repo_list_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], all : Annotated[Optional[StrictStr], Field(description="If true, mark all notifications on this repo. Default value is false")] = None, status_types : Annotated[Optional[conlist(StrictStr)], Field(description="Mark notifications with the provided status types. Options are: unread, read and/or pinned. Defaults to unread.")] = None, to_status : Annotated[Optional[StrictStr], Field(description="Status to mark notifications as. Defaults to read.")] = None, last_read_at : Annotated[Optional[datetime], Field(description="Describes the last point that notifications were checked. Anything updated since this time will not be updated.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Mark notification threads as read, pinned or unread on a specific repo  # noqa: E501
    ...
    async def notify_read_thread(self, id : Annotated[StrictStr, Field(..., description="id of notification thread")], to_status : Annotated[Optional[StrictStr], Field(description="Status to mark notifications as")] = None, **kwargs) -> NotificationThread:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the notify_read_thread_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.notify_read_thread_with_http_info(id, to_status, **kwargs)  # noqa: E501

    @validate_arguments
    async def notify_read_thread_with_http_info(self, id : Annotated[StrictStr, Field(..., description="id of notification thread")], to_status : Annotated[Optional[StrictStr], Field(description="Status to mark notifications as")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Mark notification thread as read by ID  # noqa: E501
