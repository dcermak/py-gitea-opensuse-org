...
class IssueApi:
    ...
    async def issue_add_label(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], body : Optional[IssueLabelsOption] = None, **kwargs) -> List[Label]:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_add_label_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_add_label_with_http_info(owner, repo, index, body, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_add_label_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], body : Optional[IssueLabelsOption] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Add a label to an issue  # noqa: E501
    ...
    async def issue_add_subscription(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], user : Annotated[StrictStr, Field(..., description="user to subscribe")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_add_subscription_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_add_subscription_with_http_info(owner, repo, index, user, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_add_subscription_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], user : Annotated[StrictStr, Field(..., description="user to subscribe")], **kwargs) -> ApiResponse:  # noqa: E501
        """Subscribe user to issue  # noqa: E501
    ...
    async def issue_add_time(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], body : Optional[AddTimeOption] = None, **kwargs) -> TrackedTime:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_add_time_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_add_time_with_http_info(owner, repo, index, body, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_add_time_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], body : Optional[AddTimeOption] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Add tracked time to a issue  # noqa: E501
    ...
    async def issue_check_subscription(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], **kwargs) -> WatchInfo:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_check_subscription_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_check_subscription_with_http_info(owner, repo, index, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_check_subscription_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], **kwargs) -> ApiResponse:  # noqa: E501
        """Check if user is subscribed to an issue  # noqa: E501
    ...
    async def issue_clear_labels(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_clear_labels_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_clear_labels_with_http_info(owner, repo, index, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_clear_labels_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], **kwargs) -> ApiResponse:  # noqa: E501
        """Remove all labels from an issue  # noqa: E501
    ...
    async def issue_create_comment(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], body : Optional[CreateIssueCommentOption] = None, **kwargs) -> Comment:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_create_comment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_create_comment_with_http_info(owner, repo, index, body, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_create_comment_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], body : Optional[CreateIssueCommentOption] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Add a comment to an issue  # noqa: E501
    ...
    async def issue_create_issue(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], body : Optional[CreateIssueOption] = None, **kwargs) -> Issue:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_create_issue_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_create_issue_with_http_info(owner, repo, body, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_create_issue_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], body : Optional[CreateIssueOption] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create an issue. If using deadline only the date will be taken into account, and time of day ignored.  # noqa: E501
    ...
    async def issue_create_issue_attachment(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], attachment : Annotated[Union[StrictBytes, StrictStr], Field(..., description="attachment to upload")], name : Annotated[Optional[StrictStr], Field(description="name of the attachment")] = None, **kwargs) -> Attachment:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_create_issue_attachment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_create_issue_attachment_with_http_info(owner, repo, index, attachment, name, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_create_issue_attachment_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], attachment : Annotated[Union[StrictBytes, StrictStr], Field(..., description="attachment to upload")], name : Annotated[Optional[StrictStr], Field(description="name of the attachment")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create an issue attachment  # noqa: E501
    ...
    async def issue_create_issue_comment_attachment(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment")], attachment : Annotated[Union[StrictBytes, StrictStr], Field(..., description="attachment to upload")], name : Annotated[Optional[StrictStr], Field(description="name of the attachment")] = None, **kwargs) -> Attachment:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_create_issue_comment_attachment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_create_issue_comment_attachment_with_http_info(owner, repo, id, attachment, name, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_create_issue_comment_attachment_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment")], attachment : Annotated[Union[StrictBytes, StrictStr], Field(..., description="attachment to upload")], name : Annotated[Optional[StrictStr], Field(description="name of the attachment")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a comment attachment  # noqa: E501
    ...
    async def issue_create_label(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], body : Optional[CreateLabelOption] = None, **kwargs) -> Label:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_create_label_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_create_label_with_http_info(owner, repo, body, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_create_label_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], body : Optional[CreateLabelOption] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a label  # noqa: E501
    ...
    async def issue_create_milestone(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], body : Optional[CreateMilestoneOption] = None, **kwargs) -> Milestone:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_create_milestone_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_create_milestone_with_http_info(owner, repo, body, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_create_milestone_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], body : Optional[CreateMilestoneOption] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a milestone  # noqa: E501
    ...
    async def issue_delete(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of issue to delete")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_delete_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_delete_with_http_info(owner, repo, index, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_delete_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of issue to delete")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete an issue  # noqa: E501
    ...
    async def issue_delete_comment(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of comment to delete")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_delete_comment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_delete_comment_with_http_info(owner, repo, id, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_delete_comment_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of comment to delete")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a comment  # noqa: E501
    ...
    async def issue_delete_comment_deprecated(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="this parameter is ignored")], id : Annotated[StrictInt, Field(..., description="id of comment to delete")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_delete_comment_deprecated_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_delete_comment_deprecated_with_http_info(owner, repo, index, id, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_delete_comment_deprecated_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="this parameter is ignored")], id : Annotated[StrictInt, Field(..., description="id of comment to delete")], **kwargs) -> ApiResponse:  # noqa: E501
        """(Deprecated) Delete a comment  # noqa: E501
    ...
    async def issue_delete_comment_reaction(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment to edit")], content : Optional[EditReactionOption] = None, **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_delete_comment_reaction_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_delete_comment_reaction_with_http_info(owner, repo, id, content, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_delete_comment_reaction_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment to edit")], content : Optional[EditReactionOption] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Remove a reaction from a comment of an issue  # noqa: E501
    ...
    async def issue_delete_issue_attachment(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], attachment_id : Annotated[StrictInt, Field(..., description="id of the attachment to delete")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_delete_issue_attachment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_delete_issue_attachment_with_http_info(owner, repo, index, attachment_id, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_delete_issue_attachment_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], attachment_id : Annotated[StrictInt, Field(..., description="id of the attachment to delete")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete an issue attachment  # noqa: E501
    ...
    async def issue_delete_issue_comment_attachment(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment")], attachment_id : Annotated[StrictInt, Field(..., description="id of the attachment to delete")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_delete_issue_comment_attachment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_delete_issue_comment_attachment_with_http_info(owner, repo, id, attachment_id, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_delete_issue_comment_attachment_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment")], attachment_id : Annotated[StrictInt, Field(..., description="id of the attachment to delete")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a comment attachment  # noqa: E501
    ...
    async def issue_delete_issue_reaction(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], content : Optional[EditReactionOption] = None, **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_delete_issue_reaction_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_delete_issue_reaction_with_http_info(owner, repo, index, content, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_delete_issue_reaction_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], content : Optional[EditReactionOption] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Remove a reaction from an issue  # noqa: E501
    ...
    async def issue_delete_label(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the label to delete")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_delete_label_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_delete_label_with_http_info(owner, repo, id, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_delete_label_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the label to delete")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a label  # noqa: E501
    ...
    async def issue_delete_milestone(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictStr, Field(..., description="the milestone to delete, identified by ID and if not available by name")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_delete_milestone_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_delete_milestone_with_http_info(owner, repo, id, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_delete_milestone_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictStr, Field(..., description="the milestone to delete, identified by ID and if not available by name")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a milestone  # noqa: E501
    ...
    async def issue_delete_stop_watch(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue to stop the stopwatch on")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_delete_stop_watch_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_delete_stop_watch_with_http_info(owner, repo, index, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_delete_stop_watch_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue to stop the stopwatch on")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete an issue's existing stopwatch.  # noqa: E501
    ...
    async def issue_delete_subscription(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], user : Annotated[StrictStr, Field(..., description="user witch unsubscribe")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_delete_subscription_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_delete_subscription_with_http_info(owner, repo, index, user, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_delete_subscription_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], user : Annotated[StrictStr, Field(..., description="user witch unsubscribe")], **kwargs) -> ApiResponse:  # noqa: E501
        """Unsubscribe user from issue  # noqa: E501
    ...
    async def issue_delete_time(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], id : Annotated[StrictInt, Field(..., description="id of time to delete")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_delete_time_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_delete_time_with_http_info(owner, repo, index, id, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_delete_time_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], id : Annotated[StrictInt, Field(..., description="id of time to delete")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete specific tracked time  # noqa: E501
    ...
    async def issue_edit_comment(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment to edit")], body : Optional[EditIssueCommentOption] = None, **kwargs) -> Comment:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_edit_comment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_edit_comment_with_http_info(owner, repo, id, body, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_edit_comment_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment to edit")], body : Optional[EditIssueCommentOption] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Edit a comment  # noqa: E501
    ...
    async def issue_edit_comment_deprecated(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="this parameter is ignored")], id : Annotated[StrictInt, Field(..., description="id of the comment to edit")], body : Optional[EditIssueCommentOption] = None, **kwargs) -> Comment:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_edit_comment_deprecated_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_edit_comment_deprecated_with_http_info(owner, repo, index, id, body, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_edit_comment_deprecated_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="this parameter is ignored")], id : Annotated[StrictInt, Field(..., description="id of the comment to edit")], body : Optional[EditIssueCommentOption] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """(Deprecated) Edit a comment  # noqa: E501
    ...
    async def issue_edit_issue(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue to edit")], body : Optional[EditIssueOption] = None, **kwargs) -> Issue:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_edit_issue_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_edit_issue_with_http_info(owner, repo, index, body, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_edit_issue_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue to edit")], body : Optional[EditIssueOption] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Edit an issue. If using deadline only the date will be taken into account, and time of day ignored.  # noqa: E501
    ...
    async def issue_edit_issue_attachment(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], attachment_id : Annotated[StrictInt, Field(..., description="id of the attachment to edit")], body : Optional[EditAttachmentOptions] = None, **kwargs) -> Attachment:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_edit_issue_attachment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_edit_issue_attachment_with_http_info(owner, repo, index, attachment_id, body, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_edit_issue_attachment_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], attachment_id : Annotated[StrictInt, Field(..., description="id of the attachment to edit")], body : Optional[EditAttachmentOptions] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Edit an issue attachment  # noqa: E501
    ...
    async def issue_edit_issue_comment_attachment(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment")], attachment_id : Annotated[StrictInt, Field(..., description="id of the attachment to edit")], body : Optional[EditAttachmentOptions] = None, **kwargs) -> Attachment:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_edit_issue_comment_attachment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_edit_issue_comment_attachment_with_http_info(owner, repo, id, attachment_id, body, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_edit_issue_comment_attachment_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment")], attachment_id : Annotated[StrictInt, Field(..., description="id of the attachment to edit")], body : Optional[EditAttachmentOptions] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Edit a comment attachment  # noqa: E501
    ...
    async def issue_edit_issue_deadline(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue to create or update a deadline on")], body : Optional[EditDeadlineOption] = None, **kwargs) -> IssueDeadline:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_edit_issue_deadline_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_edit_issue_deadline_with_http_info(owner, repo, index, body, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_edit_issue_deadline_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue to create or update a deadline on")], body : Optional[EditDeadlineOption] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Set an issue deadline. If set to null, the deadline is deleted. If using deadline only the date will be taken into account, and time of day ignored.  # noqa: E501
    ...
    async def issue_edit_label(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the label to edit")], body : Optional[EditLabelOption] = None, **kwargs) -> Label:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_edit_label_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_edit_label_with_http_info(owner, repo, id, body, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_edit_label_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the label to edit")], body : Optional[EditLabelOption] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update a label  # noqa: E501
    ...
    async def issue_edit_milestone(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictStr, Field(..., description="the milestone to edit, identified by ID and if not available by name")], body : Optional[EditMilestoneOption] = None, **kwargs) -> Milestone:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_edit_milestone_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_edit_milestone_with_http_info(owner, repo, id, body, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_edit_milestone_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictStr, Field(..., description="the milestone to edit, identified by ID and if not available by name")], body : Optional[EditMilestoneOption] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update a milestone  # noqa: E501
    ...
    async def issue_get_comment(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment")], **kwargs) -> Comment:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_get_comment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_get_comment_with_http_info(owner, repo, id, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_get_comment_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get a comment  # noqa: E501
    ...
    async def issue_get_comment_reactions(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment to edit")], **kwargs) -> List[Reaction]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_get_comment_reactions_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_get_comment_reactions_with_http_info(owner, repo, id, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_get_comment_reactions_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment to edit")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get a list of reactions from a comment of an issue  # noqa: E501
    ...
    async def issue_get_comments(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], since : Annotated[Optional[datetime], Field(description="if provided, only comments updated since the specified time are returned.")] = None, before : Annotated[Optional[datetime], Field(description="if provided, only comments updated before the provided time are returned.")] = None, **kwargs) -> List[Comment]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_get_comments_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_get_comments_with_http_info(owner, repo, index, since, before, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_get_comments_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], since : Annotated[Optional[datetime], Field(description="if provided, only comments updated since the specified time are returned.")] = None, before : Annotated[Optional[datetime], Field(description="if provided, only comments updated before the provided time are returned.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List all comments on an issue  # noqa: E501
    ...
    async def issue_get_comments_and_timeline(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], since : Annotated[Optional[datetime], Field(description="if provided, only comments updated since the specified time are returned.")] = None, page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, before : Annotated[Optional[datetime], Field(description="if provided, only comments updated before the provided time are returned.")] = None, **kwargs) -> List[TimelineComment]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_get_comments_and_timeline_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_get_comments_and_timeline_with_http_info(owner, repo, index, since, page, limit, before, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_get_comments_and_timeline_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], since : Annotated[Optional[datetime], Field(description="if provided, only comments updated since the specified time are returned.")] = None, page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, before : Annotated[Optional[datetime], Field(description="if provided, only comments updated before the provided time are returned.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List all comments and events on an issue  # noqa: E501
    ...
    async def issue_get_issue(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue to get")], **kwargs) -> Issue:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_get_issue_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_get_issue_with_http_info(owner, repo, index, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_get_issue_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue to get")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get an issue  # noqa: E501
    ...
    async def issue_get_issue_attachment(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], attachment_id : Annotated[StrictInt, Field(..., description="id of the attachment to get")], **kwargs) -> Attachment:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_get_issue_attachment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_get_issue_attachment_with_http_info(owner, repo, index, attachment_id, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_get_issue_attachment_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], attachment_id : Annotated[StrictInt, Field(..., description="id of the attachment to get")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get an issue attachment  # noqa: E501
    ...
    async def issue_get_issue_comment_attachment(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment")], attachment_id : Annotated[StrictInt, Field(..., description="id of the attachment to get")], **kwargs) -> Attachment:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_get_issue_comment_attachment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_get_issue_comment_attachment_with_http_info(owner, repo, id, attachment_id, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_get_issue_comment_attachment_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment")], attachment_id : Annotated[StrictInt, Field(..., description="id of the attachment to get")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get a comment attachment  # noqa: E501
    ...
    async def issue_get_issue_reactions(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> List[Reaction]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_get_issue_reactions_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_get_issue_reactions_with_http_info(owner, repo, index, page, limit, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_get_issue_reactions_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get a list reactions of an issue  # noqa: E501
    ...
    async def issue_get_label(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the label to get")], **kwargs) -> Label:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_get_label_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_get_label_with_http_info(owner, repo, id, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_get_label_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the label to get")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get a single label  # noqa: E501
    ...
    async def issue_get_labels(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], **kwargs) -> List[Label]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_get_labels_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_get_labels_with_http_info(owner, repo, index, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_get_labels_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get an issue's labels  # noqa: E501
    ...
    async def issue_get_milestone(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictStr, Field(..., description="the milestone to get, identified by ID and if not available by name")], **kwargs) -> Milestone:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_get_milestone_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_get_milestone_with_http_info(owner, repo, id, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_get_milestone_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictStr, Field(..., description="the milestone to get, identified by ID and if not available by name")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get a milestone  # noqa: E501
    ...
    async def issue_get_repo_comments(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], since : Annotated[Optional[datetime], Field(description="if provided, only comments updated since the provided time are returned.")] = None, before : Annotated[Optional[datetime], Field(description="if provided, only comments updated before the provided time are returned.")] = None, page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> List[Comment]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_get_repo_comments_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_get_repo_comments_with_http_info(owner, repo, since, before, page, limit, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_get_repo_comments_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], since : Annotated[Optional[datetime], Field(description="if provided, only comments updated since the provided time are returned.")] = None, before : Annotated[Optional[datetime], Field(description="if provided, only comments updated before the provided time are returned.")] = None, page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List all comments in a repository  # noqa: E501
    ...
    async def issue_list_issue_attachments(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], **kwargs) -> List[Attachment]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_list_issue_attachments_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_list_issue_attachments_with_http_info(owner, repo, index, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_list_issue_attachments_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], **kwargs) -> ApiResponse:  # noqa: E501
        """List issue's attachments  # noqa: E501
    ...
    async def issue_list_issue_comment_attachments(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment")], **kwargs) -> List[Attachment]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_list_issue_comment_attachments_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_list_issue_comment_attachments_with_http_info(owner, repo, id, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_list_issue_comment_attachments_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment")], **kwargs) -> ApiResponse:  # noqa: E501
        """List comment's attachments  # noqa: E501
    ...
    async def issue_list_issues(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], state : Annotated[Optional[StrictStr], Field(description="whether issue is open or closed")] = None, labels : Annotated[Optional[StrictStr], Field(description="comma separated list of labels. Fetch only issues that have any of this labels. Non existent labels are discarded")] = None, q : Annotated[Optional[StrictStr], Field(description="search string")] = None, type : Annotated[Optional[StrictStr], Field(description="filter by type (issues / pulls) if set")] = None, milestones : Annotated[Optional[StrictStr], Field(description="comma separated list of milestone names or ids. It uses names and fall back to ids. Fetch only issues that have any of this milestones. Non existent milestones are discarded")] = None, since : Annotated[Optional[datetime], Field(description="Only show items updated after the given time. This is a timestamp in RFC 3339 format")] = None, before : Annotated[Optional[datetime], Field(description="Only show items updated before the given time. This is a timestamp in RFC 3339 format")] = None, created_by : Annotated[Optional[StrictStr], Field(description="Only show items which were created by the the given user")] = None, assigned_by : Annotated[Optional[StrictStr], Field(description="Only show items for which the given user is assigned")] = None, mentioned_by : Annotated[Optional[StrictStr], Field(description="Only show items in which the given user was mentioned")] = None, page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> List[Issue]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_list_issues_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_list_issues_with_http_info(owner, repo, state, labels, q, type, milestones, since, before, created_by, assigned_by, mentioned_by, page, limit, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_list_issues_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], state : Annotated[Optional[StrictStr], Field(description="whether issue is open or closed")] = None, labels : Annotated[Optional[StrictStr], Field(description="comma separated list of labels. Fetch only issues that have any of this labels. Non existent labels are discarded")] = None, q : Annotated[Optional[StrictStr], Field(description="search string")] = None, type : Annotated[Optional[StrictStr], Field(description="filter by type (issues / pulls) if set")] = None, milestones : Annotated[Optional[StrictStr], Field(description="comma separated list of milestone names or ids. It uses names and fall back to ids. Fetch only issues that have any of this milestones. Non existent milestones are discarded")] = None, since : Annotated[Optional[datetime], Field(description="Only show items updated after the given time. This is a timestamp in RFC 3339 format")] = None, before : Annotated[Optional[datetime], Field(description="Only show items updated before the given time. This is a timestamp in RFC 3339 format")] = None, created_by : Annotated[Optional[StrictStr], Field(description="Only show items which were created by the the given user")] = None, assigned_by : Annotated[Optional[StrictStr], Field(description="Only show items for which the given user is assigned")] = None, mentioned_by : Annotated[Optional[StrictStr], Field(description="Only show items in which the given user was mentioned")] = None, page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List a repository's issues  # noqa: E501
    ...
    async def issue_list_labels(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> List[Label]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_list_labels_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_list_labels_with_http_info(owner, repo, page, limit, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_list_labels_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get all of a repository's labels  # noqa: E501
    ...
    async def issue_post_comment_reaction(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment to edit")], content : Optional[EditReactionOption] = None, **kwargs) -> Reaction:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_post_comment_reaction_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_post_comment_reaction_with_http_info(owner, repo, id, content, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_post_comment_reaction_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], id : Annotated[StrictInt, Field(..., description="id of the comment to edit")], content : Optional[EditReactionOption] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Add a reaction to a comment of an issue  # noqa: E501
    ...
    async def issue_post_issue_reaction(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], content : Optional[EditReactionOption] = None, **kwargs) -> Reaction:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_post_issue_reaction_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_post_issue_reaction_with_http_info(owner, repo, index, content, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_post_issue_reaction_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], content : Optional[EditReactionOption] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Add a reaction to an issue  # noqa: E501
    ...
    async def issue_remove_label(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], id : Annotated[StrictInt, Field(..., description="id of the label to remove")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_remove_label_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_remove_label_with_http_info(owner, repo, index, id, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_remove_label_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], id : Annotated[StrictInt, Field(..., description="id of the label to remove")], **kwargs) -> ApiResponse:  # noqa: E501
        """Remove a label from an issue  # noqa: E501
    ...
    async def issue_replace_labels(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], body : Optional[IssueLabelsOption] = None, **kwargs) -> List[Label]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_replace_labels_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_replace_labels_with_http_info(owner, repo, index, body, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_replace_labels_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], body : Optional[IssueLabelsOption] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Replace an issue's labels  # noqa: E501
    ...
    async def issue_reset_time(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue to add tracked time to")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_reset_time_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_reset_time_with_http_info(owner, repo, index, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_reset_time_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue to add tracked time to")], **kwargs) -> ApiResponse:  # noqa: E501
        """Reset a tracked time of an issue  # noqa: E501
    ...
    async def issue_search_issues(self, state : Annotated[Optional[StrictStr], Field(description="whether issue is open or closed")] = None, labels : Annotated[Optional[StrictStr], Field(description="comma separated list of labels. Fetch only issues that have any of this labels. Non existent labels are discarded")] = None, milestones : Annotated[Optional[StrictStr], Field(description="comma separated list of milestone names. Fetch only issues that have any of this milestones. Non existent are discarded")] = None, q : Annotated[Optional[StrictStr], Field(description="search string")] = None, priority_repo_id : Annotated[Optional[StrictInt], Field(description="repository to prioritize in the results")] = None, type : Annotated[Optional[StrictStr], Field(description="filter by type (issues / pulls) if set")] = None, since : Annotated[Optional[datetime], Field(description="Only show notifications updated after the given time. This is a timestamp in RFC 3339 format")] = None, before : Annotated[Optional[datetime], Field(description="Only show notifications updated before the given time. This is a timestamp in RFC 3339 format")] = None, assigned : Annotated[Optional[StrictBool], Field(description="filter (issues / pulls) assigned to you, default is false")] = None, created : Annotated[Optional[StrictBool], Field(description="filter (issues / pulls) created by you, default is false")] = None, mentioned : Annotated[Optional[StrictBool], Field(description="filter (issues / pulls) mentioning you, default is false")] = None, review_requested : Annotated[Optional[StrictBool], Field(description="filter pulls requesting your review, default is false")] = None, owner : Annotated[Optional[StrictStr], Field(description="filter by owner")] = None, team : Annotated[Optional[StrictStr], Field(description="filter by team (requires organization owner parameter to be provided)")] = None, page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> List[Issue]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_search_issues_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_search_issues_with_http_info(state, labels, milestones, q, priority_repo_id, type, since, before, assigned, created, mentioned, review_requested, owner, team, page, limit, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_search_issues_with_http_info(self, state : Annotated[Optional[StrictStr], Field(description="whether issue is open or closed")] = None, labels : Annotated[Optional[StrictStr], Field(description="comma separated list of labels. Fetch only issues that have any of this labels. Non existent labels are discarded")] = None, milestones : Annotated[Optional[StrictStr], Field(description="comma separated list of milestone names. Fetch only issues that have any of this milestones. Non existent are discarded")] = None, q : Annotated[Optional[StrictStr], Field(description="search string")] = None, priority_repo_id : Annotated[Optional[StrictInt], Field(description="repository to prioritize in the results")] = None, type : Annotated[Optional[StrictStr], Field(description="filter by type (issues / pulls) if set")] = None, since : Annotated[Optional[datetime], Field(description="Only show notifications updated after the given time. This is a timestamp in RFC 3339 format")] = None, before : Annotated[Optional[datetime], Field(description="Only show notifications updated before the given time. This is a timestamp in RFC 3339 format")] = None, assigned : Annotated[Optional[StrictBool], Field(description="filter (issues / pulls) assigned to you, default is false")] = None, created : Annotated[Optional[StrictBool], Field(description="filter (issues / pulls) created by you, default is false")] = None, mentioned : Annotated[Optional[StrictBool], Field(description="filter (issues / pulls) mentioning you, default is false")] = None, review_requested : Annotated[Optional[StrictBool], Field(description="filter pulls requesting your review, default is false")] = None, owner : Annotated[Optional[StrictStr], Field(description="filter by owner")] = None, team : Annotated[Optional[StrictStr], Field(description="filter by team (requires organization owner parameter to be provided)")] = None, page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Search for issues across the repositories that the user has access to  # noqa: E501
    ...
    async def issue_start_stop_watch(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue to create the stopwatch on")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_start_stop_watch_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_start_stop_watch_with_http_info(owner, repo, index, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_start_stop_watch_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue to create the stopwatch on")], **kwargs) -> ApiResponse:  # noqa: E501
        """Start stopwatch on an issue.  # noqa: E501
    ...
    async def issue_stop_stop_watch(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue to stop the stopwatch on")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_stop_stop_watch_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_stop_stop_watch_with_http_info(owner, repo, index, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_stop_stop_watch_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue to stop the stopwatch on")], **kwargs) -> ApiResponse:  # noqa: E501
        """Stop an issue's existing stopwatch.  # noqa: E501
    ...
    async def issue_subscriptions(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> List[User]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_subscriptions_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_subscriptions_with_http_info(owner, repo, index, page, limit, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_subscriptions_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get users who subscribed on an issue.  # noqa: E501
    ...
    async def issue_tracked_times(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], user : Annotated[Optional[StrictStr], Field(description="optional filter by user (available for issue managers)")] = None, since : Annotated[Optional[datetime], Field(description="Only show times updated after the given time. This is a timestamp in RFC 3339 format")] = None, before : Annotated[Optional[datetime], Field(description="Only show times updated before the given time. This is a timestamp in RFC 3339 format")] = None, page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> List[TrackedTime]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the issue_tracked_times_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.issue_tracked_times_with_http_info(owner, repo, index, user, since, before, page, limit, **kwargs)  # noqa: E501

    @validate_arguments
    async def issue_tracked_times_with_http_info(self, owner : Annotated[StrictStr, Field(..., description="owner of the repo")], repo : Annotated[StrictStr, Field(..., description="name of the repo")], index : Annotated[StrictInt, Field(..., description="index of the issue")], user : Annotated[Optional[StrictStr], Field(description="optional filter by user (available for issue managers)")] = None, since : Annotated[Optional[datetime], Field(description="Only show times updated after the given time. This is a timestamp in RFC 3339 format")] = None, before : Annotated[Optional[datetime], Field(description="Only show times updated before the given time. This is a timestamp in RFC 3339 format")] = None, page : Annotated[Optional[StrictInt], Field(description="page number of results to return (1-based)")] = None, limit : Annotated[Optional[StrictInt], Field(description="page size of results")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List an issue's tracked times  # noqa: E501
