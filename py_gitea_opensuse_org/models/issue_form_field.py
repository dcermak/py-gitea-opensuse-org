...
class IssueFormField(BaseModel):
    ...
    """ # noqa: E501
    attributes: Optional[Dict[str, Union[str, Any]]] = None
    id: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    validations: Optional[Dict[str, Union[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["attributes", "id", "type", "validations"]
