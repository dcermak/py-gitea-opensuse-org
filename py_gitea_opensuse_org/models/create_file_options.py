...
class CreateFileOptions(BaseModel):
    """
    CreateFileOptions options for creating files Note: `author` and `committer` are optional (if only one is given, it will be used for the other, otherwise the authenticated user will be used)  # noqa: E501
    """
    ...
    __properties = ["author", "branch", "committer", "content", "dates", "message", "new_branch", "signoff"]
